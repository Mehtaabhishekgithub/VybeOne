           ...
           {/* div for name and username */}
              <div>
               ...
               <div className='text-[15px] text-gray-400 font-semibold'>{user.name}</div>
                ...
                <button className='px-[10px] w-[100px] py-[5px] h-[40px] bg-white rounded-2xl '>
                  Follow
                </button>
            </div>
  )
