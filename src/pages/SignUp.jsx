...
const SignUp = () => {
  ...
  return (
    <div
      className="w-full h-screen bg-gradient-to-b from-black to-gray-900 flex flex-col justify-center
     items-center"
    >
      <div
        className="w-[90%] lg:max-w-[60%] h-[600px]  bg-[#fbfbfc] rounded-2xl flex justify-center items-center
        ...
        <div className="w-full lg:w-[50%] h-full bg-white flex flex-col items-center p-[10px] gap-[20px]">
          ...
          <p className="cursor-pointer text-gray-800">
            ...
            <span
              ...
              className=" pb-[3px]  text-blue-500"
            >
              SignIn
            </span>
          </p>
